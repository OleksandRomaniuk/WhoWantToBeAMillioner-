...
public class LastmenuFi extends AppCompatActivity implements Serializable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadData();
            ...
            if(numpoints2>60&&numpoints2<200) {
                animText.setText("60");
             fongood.setImageResource(R.drawable.fonbad);
            }
        if(numpoints2==200) {
        ...
        buttonRest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    //sound.start();
                    Intent intent =new Intent(LastmenuFi.this,PlayButtom.class);
        ...
        buttonHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    //sound.start();
                    Intent intent =new Intent(LastmenuFi.this,MainActivity.class);
                    startActivity(intent);finish();
                }
                catch (Exception e){
    ...
    public void loadData() {
        ...
        numpoints2 = sharedPreferences.getInt("rescopy3",0);
